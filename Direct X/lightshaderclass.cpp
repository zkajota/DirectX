...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	WCHAR lightvs[] = L"../light.vs";
	WCHAR lightps[] = L"../light.ps";
...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, int vertexCount, int instanceCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
