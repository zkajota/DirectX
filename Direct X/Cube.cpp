...
bool Cube::Initialise(ID3D11Device *_device)
{
	bool result;
	
	result = InitalizeBuffers(_device);
...
void Cube::Render(ID3D11DeviceContext *_deviceContext)
{
...
bool Cube::InitalizeBuffers(ID3D11Device *_device)
{
	VertexType* vertices;
...
void Cube::RenderBuffers(ID3D11DeviceContext *_deviceContext)
{
	unsigned int stride;
	unsigned int offset;
